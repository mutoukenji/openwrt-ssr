...
PKG_SOURCE_URL:=https://github.com/shadowsocksr-backup/shadowsocksr-libev
PKG_SOURCE_VERSION:=58f30fd8e352c262ac13303415d0dc41143052d5
...
PKG_MAINTAINER:=mutoukenji <mutoukenji@gmail.com>
...
define Package/openwrt-ssr/Default
	...
	URL:=https://github.com/mutoukenji/openwrt-ssr
	VARIANT:=$(1)
	DEPENDS:=$(3)	
	PKGARCH:=all
endef
...
define Package/luci-app-shadowsocksR-GFW/install
	...
	$(INSTALL_BIN) ./files/ssr-check $(1)/usr/bin/ssr-check
